...
\begin{document}
	...
	\begin{minipage}[t]{0.66\textwidth} 
		...
		\begin{tightemize}
			\item Worked as facilitator for deploying {\ibf Kaizen} (Continuous Improvement) events and {\ibf R}oot {\ibf C}ause {\ibf A}nalysis to help the {\ibf A}dvanced {\ibf M}odule {\ibf E}ngineering modules reduce usage of test wafers in pre-production \& tool qualifications.
